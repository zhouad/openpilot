...
class Controls:
  def __init__(self, CI=None):
    ...
    if not sounds_available and not self.disable_dm: #modify
  ...
  def update_events(self, CS):
    ...
    if not self.sm.all_checks() and no_system_errors and not self.disable_dm: #modify
  ...
  def publish_logs(self, CS, start_time, CC, lac_log):
    ...
    controlsState.experimentalMode = self.experimental_mode and self.user_experimental_mode #new
