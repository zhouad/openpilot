...
def make_msg(face_detected=True, distracted=False, model_uncertain=False):
  ...
  ds.leftDriverData.leftBlinkProb = 0.
  ds.leftDriverData.rightBlinkProb = 0.
  ds.leftDriverData.faceOrientationStd = [1.*model_uncertain, 1.*model_uncertain, 1.*model_uncertain]
  ds.leftDriverData.facePositionStd = [1.*model_uncertain, 1.*model_uncertain]
  ds.leftDriverData.readyProb = [1., 1., 1., 1.]
