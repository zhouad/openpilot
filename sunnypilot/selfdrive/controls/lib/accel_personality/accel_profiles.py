...
MIN_ACCEL_PROFILES = {
  "eco":                [-.08,  -.12,  -0.10, -0.08, -0.07, -0.07, -0.65, -0.65],
  "normal":             [-.09,  -.13,  -0.11, -0.09, -0.08, -0.08, -0.70, -0.70],
  "sport":              [-.10,  -.14,  -0.12, -0.10, -0.09, -0.09, -0.75, -0.75],
  "stock":              [-1.2,  -1.2,  -1.2,  -1.2,  -1.2,  -1.2,  -1.2,  -1.2],
}
MIN_ACCEL_BREAKPOINTS = [0.,     0.7,   1.2,  5.,    8.,   12.,   25.,   40.]
