...
# Profiles
MAX_ACCEL_PROFILES = {
  "eco":                [2.00, 1.95, 1.90, 1.52, 0.82, .572, .46, .37, .32, .10],
...
MIN_ACCEL_PROFILES = {
  "eco":                [-.0007,  -.0011,  -0.005, -0.05, -0.65, -0.65],
  "normal":             [-.0008,  -.0012,  -0.006, -0.06, -0.70, -0.70],
  "sport":              [-.0009,  -.0013,  -0.007, -0.07, -0.75, -0.75],
  "stock":              [-1.2,    -1.2,    -1.2,   -1.2,  -1.2,  -1.2],
}
MIN_ACCEL_BREAKPOINTS = [0.,      3.,      5.,     8.,    25.,    40.]
