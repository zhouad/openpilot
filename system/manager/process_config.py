...
procs = [
  ...
  # PythonProcess("dmonitoringmodeld", "selfdrive.modeld.dmonitoringmodeld", driverview, enabled=False),  # 完全移除驾驶员监控模型
  ...
  # PythonProcess("dmonitoringd", "selfdrive.monitoring.dmonitoringd", driverview, enabled=False),  # 完全移除驾驶员监控服务
