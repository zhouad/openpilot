...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"dp_device_monitoring_disabled", {PERSISTENT, BOOL, "1"}},
    {"dp_device_beep", {PERSISTENT, BOOL, "1"}},
    ...
    {"dp_ui_rainbow", {PERSISTENT, BOOL, "1"}},
    ...
    {"dp_vag_avoid_eps_lockout", {PERSISTENT, BOOL, "1"}},
};
